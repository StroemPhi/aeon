...
Make sure you have an ID range in the [idranges file](aeon-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [aeon-edit.owl](aeon-edit.owl)

** DO NOT EDIT aeon.obo OR aeon.owl in the top level directory **

[../../aeon.owl](../../aeon.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/StroemPhi/aeon) for details.
 ...
 * [aeon-idranges.owl](aeon-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/aeon_terms.txt file
...
Note: the aeon_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as aeon.owl and aeon.obo and places
...
what is in the `owl:versionIRI` of the derived aeon.owl (`data-version` in
aeon.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/aeon.owl <-- current ontology PURL
