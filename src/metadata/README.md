 ...
 * [aeon.yml](aeon.yml)
     * Determines how your purl.obolibrary.org/obo/aeon/ redirects will be handled
     ...
     * Paste in the contents of [aeon.yml](aeon.yml)
 ...
 * [aeon.md](aeon.md)
     ...
     * Paste in the contents of [aeon.md](aeon.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
